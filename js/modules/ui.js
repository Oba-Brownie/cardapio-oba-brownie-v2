...
export function renderProducts(products, lojaAberta, customOrder = []) {
    ...
    // =======================================================
    // 1. LÓGICA DO CARROSSEL: Agora busca os "Destaques"
    // =======================================================
    const produtosDestaque = products.filter(p => p.destaque === true && p.estoque > 0);
    
    if (produtosDestaque.length > 0 && lojaAberta) {
        ...
        produtosDestaque.forEach(product => {
    ...
    // =======================================================
    // 2. LÓGICA DA LISTA VERTICAL (Categorias Normais)
    // =======================================================
    ...
    // =======================================================
    // 3. PRODUTOS ESGOTADOS (Ficam no final da lista)
    // =======================================================
    if (lojaAberta) {
